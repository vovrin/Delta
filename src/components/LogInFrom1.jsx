...
import { EmVerPopPup } from "./EmVerPopPup";
export default function LogInForm1(){

    const [isEmVerShow, setEmVer] = useState(false)
    ...
    return(
        <form onSubmit={formData} className="logInForm">
            ...
            <input type="password" ref={password}  className="passwordOfUser" minLength="8" required></input>
